...
function proposalEmail(estimate, link) {
  ...
  const paymentCopy = isMowingContract(estimate, contract)
    ? `<p><strong>Billing:</strong> Lawn services and any chemicals or fertilizer applied are invoiced at the end of each month. No project deposit is required.</p>`
...
function documentSnapshot(estimate, customerDetails = {}) {
  ...
  return {
    ...
    payment_terms: mowing
      ? "Lawn services and any chemicals or fertilizer applied are invoiced at the end of each month. No project deposit is required."
...
function signedProposalEmail(estimate, snapshot, signature) {
  ...
  const signedPayment = mowing
    ? `<div style="padding:15px;border:1px solid #cad8c9"><strong>Billing</strong><p>Lawn services and any chemicals or fertilizer applied are invoiced at the end of each month. No project deposit is required.</p></div>`
